...
#define BAT_CALIB_REAL_VOLTAGE  4070      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
// Limitation settings
#define I_MOT_MAX       16              // [A] Maximum single motor current limit
